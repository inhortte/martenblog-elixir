defmodule Martenblog.Router do
  use Plug.Router
  alias Martenblog.{Utils, Anotacion, Tema, Http, BlogResolver, PoemResolver, Twtxt}
  require Logger
  ...
  get "/entry/:date" do
    inter_conn = conn |> put_resp_content_type("application/json")
    send_resp(inter_conn, 200, Anotacion.get_entry_by_date(date) |> Utils.to_json)
  end
  ...
  get "/topics" do
    conn |> put_resp_content_type("application/json") |> send_resp(200, %{:topics => Tema.all} |> Utils.to_json)
  end
  ...
  get "/piece-of-shit" do
    pieces_of_shit = File.read!('/home/polaris/various-leprosies/draining_the_pond/piece-of-shit.txt') 
                     |> String.split(~r{\n}) 
  ...
  get "/high-voltage-power-supply" do
    pieces_of_shit = File.read!('/home/polaris/various-leprosies/draining_the_pond/HIGH.VOLTAGE.POWER.SUPPLY') 
                     |> String.split(~r{\n}) 
                     |> Enum.map(&String.trim/1) 
                     |> Enum.filter(fn s -> String.length(s) > 0 end)
                     |> Enum.shuffle
  ...
  get "/lakife-grammar" do
    ...
    send_resp(
      200,
      File.read!("/home/polaris/various-leprosies/draining_the_pond/lakife-grammar.md")
    )
  end
  ...
  get "/lakife-mihupola" do
    ...
    send_resp(
      200,
      File.read!("/home/polaris/various-leprosies/draining_the_pond/lakife-mihupola.md")
    )
  end
  ...
  get "/" do
    send_file(conn, 200, "./web/public/static/flavigula/index.html")
  end
  # get "/*_rest" do
